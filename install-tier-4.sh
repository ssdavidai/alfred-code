...
echo "  → bin/"
mkdir -p "$TARGET/bin"
for b in secret secret-set alfred-code alfred-code-daemon alfred-code-dispatch alfred-code-reap-worktrees alfred-code-fix-pr alfred-code-poll-lock alfred-code-reconcile; do
